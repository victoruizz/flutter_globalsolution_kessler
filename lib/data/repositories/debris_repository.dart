import '../models/debris.dart';
import '../models/risk_level.dart';

class DebrisRepository {
  const DebrisRepository._();

  static const List<Debris> all = [
    Debris(
      id: 'DTR-001',
    ...
    Debris(
      ...
      story:
          'Lançado pela Agência Espacial Europeia em 2002 para monitoramento ambiental global, o Envisat perdeu contato em 2012 e tornou-se o maior satélite civil inativo em órbita. Sua massa de mais de 8 toneladas, a 770 km de altitude, representa um risco crítico de colisão com satélites operacionais por pelo menos 150 anos.',
    ),
    Debris(
      id: 'DTR-003',
      name: 'Cosmos 1408',
    ...
    Debris(
      ...
      story:
          'O Iridium 33 era um satélite de telecomunicações operacional quando colidiu acidentalmente com o russo Cosmos 2251 em fevereiro de 2009. Foi a primeira colisão em hipervelocidade entre dois satélites inteiros já registrada. O impacto a quase 800 km de altitude espalhou centenas de fragmentos e tornou-se um marco no estudo da Síndrome de Kessler.',
    ),
    Debris(
      id: 'DTR-006',
      name: 'Cosmos 2251',
    ...
    Debris(
      ...
      story:
          'Tanque auxiliar de combustível de um estágio superior russo Briz-M que falhou durante um lançamento em 2012, deixando propelente residual a bordo. Tanques pressurizados abandonados representam risco elevado: variações térmicas em órbita podem provocar explosões que geram dezenas de novos fragmentos, um dos principais mecanismos de crescimento da população de detritos.',
    ),
    Debris(
      id: 'DTR-010',
      name: 'SL-16 R/B',
